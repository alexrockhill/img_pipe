...
TEMPLATES = ['V1_average', 'cvs_avg35', 'cvs_avg35_inMNI152', 'fsaverage',
             ...
             'fsaverage_sym']
CORTICAL_SURFACES = [f'{hemi}.{roi}' for hemi in ('lh', 'rh')
...
ROIs = ['rAcumb', 'rAmgd', 'rCaud', 'rGP', 'rHipp', 'rPut', 'rThal',
        ...
        'lThal', 'lCaud', 'lPut', 'lGP', 'lHipp', 'lAmgd', 'lAcumb',
        'lVentDienceph', 'lThirdVent', 'lFourthVent', 'lBrainStem', 'pial',
        'lh_pial', 'rh_pial', 'bankssts', 'inferiorparietal',
        'medialorbitofrontal', 'pericalcarine', 'superiorfrontal',
        'caudalanteriorcingulate', 'inferiortemporal', 'middletemporal',
        'postcentral', 'superiorparietal', 'caudalmiddlefrontal', 'insula',
        'paracentral', 'posteriorcingulate', 'superiortemporal', 'cuneus',
        'isthmuscingulate', 'parahippocampal', 'precentral', 'supramarginal',
        'entorhinal', 'lateraloccipital', 'parsopercularis', 'precuneus',
        'temporalpole', 'frontalpole', 'lateralorbitofrontal', 'parsorbitalis',
        'rostralanteriorcingulate', 'transversetemporal', 'fusiform',
        'lingual', 'parstriangularis', 'rostralmiddlefrontal']

SUBCORTICAL = {'aseg_058.asc': 'rAcumb',
               'aseg_054.asc': 'rAmgd',
               'aseg_050.asc': 'rCaud',
               'aseg_052.asc': 'rGP',
               'aseg_053.asc': 'rHipp',
